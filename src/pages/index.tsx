            ...
            <section className={styles.section}>
              <div className={styles.bannerContent}>
                ...
                <p className={styles.paragraph}>
                  "陈" (Chen) is my family name, representing my identity and
                  heritage.
                </p>
                <p className={styles.paragraph}>
          ...
          <div className={styles.sectionGrid}>
            <section className={styles.section}>
              <div className={styles.sectionContent}>
                ...
                <p>
                  A curated collection of course notes, technical documentation,
                  and learning resources organized by topic. Browse through my
                  study materials and personal knowledge base.
                </p>
                <Link
            ...
            <section className={styles.section}>
              <div className={styles.sectionContent}>
                ...
                <p>
                  Personal reflections, project updates, and technical articles
                  that document my learning journey and discoveries in software
                  development.
                </p>
